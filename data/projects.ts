...
export const projects: Project[] = [
  ...
  {
    slug: "genesis-healthcare-automation",
    title: "Genesis Healthcare Automation",
    subtitle: "AI-enabled inventory intelligence for expiry prevention and waste reduction",
    ...
    role:
      "Product lead and workflow designer — framed the operational problem, defined the product concept, and shaped the AI-assisted inventory workflow around visibility, prioritization, and actionability.",
    approach: [
      "Mapped the inventory monitoring workflow to identify where manual review slowed decisions",
      "Focused the concept on expiry visibility, stock risk detection, and replenishment prioritization",
      "Defined an AI-assisted signal layer to surface urgent inventory actions earlier",
      "Structured the workflow around exception handling, not broad reporting alone",
      "Designed for lightweight operational adoption with clear action cues and traceable recommendations",
    ],
    solution: [
      "Inventory intelligence dashboard highlighting expiring, at-risk, and overstocked items",
      "Expiry tracking workflow with prioritization based on timing, demand, and inventory concentration",
      "Demand-aware replenishment recommendations to reduce avoidable stockouts",
      "Operational review layer that reduces manual scanning across spreadsheets and reports",
      "Decision support workflow for routing actions across inventory and operations teams",
    ],
    impact: [
      "Improved visibility into inventory risk before products reached critical expiry windows",
      "Reduced manual effort required to review inventory exceptions across locations",
      "Created a clearer operational workflow for balancing waste reduction and product availability",
    ],
    metrics: [],
    skills: [
    ...
    tags: ["Healthcare", "AI", "Inventory Intelligence", "Workflow Automation", "Product Management"],
    lessonsLearned:
      "Operational AI is most useful when it narrows attention to the few decisions that matter right now. Framing the workflow around inventory exceptions and action prioritization created a much clearer value proposition than trying to replace every existing report.",
  },
  {
  ...
  },
  {
    ...
    featured: true,
    summary:
      "Strategic operations project focused on standardizing Sales BOM creation through clearer governance, reusable structures, and AI-assisted workflow concepts.",
    problem:
  ...
  },
  {
    ...
    featured: true,
    summary:
      "Payments strategy project analyzing market dynamics, customer segmentation, and payment rail adoption to support Amazon Business Mexico SMB growth.",
    problem:
