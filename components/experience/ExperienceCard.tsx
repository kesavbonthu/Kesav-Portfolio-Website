      ...
      <div className="rounded-2xl border border-slate-700 bg-slate-800/40 p-6">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <div className="mt-1.5 flex items-center gap-2 text-base text-slate-400">
        ...
        <p className="mt-4 text-base text-slate-400 leading-relaxed">{exp.summary}</p>
          ...
          <div className="mt-5 flex flex-wrap gap-6">
            {exp.metrics.map((m, i) => (
              <div key={i} className="text-center">
                <div className="text-2xl font-extrabold text-blue-400">{m.value}</div>
